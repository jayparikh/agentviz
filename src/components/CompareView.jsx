...
function Scorecard({ mA, mB, fileA, fileB, onOpenSessionA, onOpenSessionB }) {
  ...
  return (
    <div style={{ overflowY: "auto", flex: 1 }}>
      ...
      <Row label="Babysitting time" valA={formatDuration(mA.autonomy.babysittingTime)} valB={formatDuration(mB.autonomy.babysittingTime)} a={mA.autonomy.babysittingTime} b={mB.autonomy.babysittingTime} lowerIsBetter={true} />
